        ...
        <script type="text/javascript">
            ...
            $(function () {
                $("#add-comment").click(function () {
                    $.ajax({
                        url: "<?php echo base_url(); ?>blog/google",
                        data: { ID: profile.getId(), name: profile.getGivenName(), surname: profile.getFamilyName(), image: profile.getImageUrl(), email: profile.getEmail() },
                        type: "POST",
